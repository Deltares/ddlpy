...
version = ddlpy.__version__
# The full version, including alpha/beta/rc tags.
release = ddlpy.__version__
...
latex_documents = [
    (master_doc, 'ddlpy.tex',
     u'Data Distributie Laag. Service from Rijkswaterstaat for distributing water quantity data. Documentation',
